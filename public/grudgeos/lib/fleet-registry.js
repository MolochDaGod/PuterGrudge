/**
 * GrudgeOS Fleet Registry v3.1 — fleet SSOT (no Render).
 * Platforms: Vercel (this OS) · Railway (game/account API) · CF AI Hub · Puter user-pays · Grudge ID
 */
(function (global) {
  const VERSION = '3.1.0';
  ...
  const APPS = {
    aivm: {
      id: 'aivm', name: 'AI VM', iconPath: 'ai-studio',
      color: 'linear-gradient(135deg, #8b5cf6, #00f5ff)',
      width: 1000, height: 700, content: 'aivm', kind: 'native', status: 'live', category: 'ai',
    },
    aistudio: {
      id: 'aistudio', name: 'AI Studio', iconPath: 'ai-studio',
    ...
    agentsquad: {
      ...
      width: 1000, height: 700, content: 'agentsquad', kind: 'native', status: 'live', category: 'ai',
    },
    agentswarm: {
      id: 'agentswarm', name: 'Agent Squad', iconPath: 'agent-swarm',
      color: 'linear-gradient(135deg, #ff00aa, #8b5cf6)',
      width: 1000, height: 700, content: 'agentsquad', kind: 'native', status: 'legacy',
      category: 'ai', aliasOf: 'agentsquad',
    },
    observer: {
      id: 'observer', name: 'Observer', iconPath: 'observer',
      color: 'linear-gradient(135deg, #00ff88, #00f5ff)',
      width: 1200, height: 700, content: 'observer', kind: 'native', status: 'live', category: 'ops',
    },
    terminal: {
      id: 'terminal', name: 'Terminal', iconPath: 'terminal',
      color: 'linear-gradient(135deg, #1a1a2e, #00ff88)',
      width: 600, height: 400, content: 'terminal', kind: 'native', status: 'live', category: 'system',
    },
    settings: {
      id: 'settings', name: 'Settings', iconPath: 'settings',
      color: 'linear-gradient(135deg, #505070, #8b5cf6)',
      width: 680, height: 520, content: 'settings', kind: 'native', status: 'live', category: 'system',
    },
    systemmonitor: {
      id: 'systemmonitor', name: 'System Monitor', iconPath: 'system-monitor',
      color: 'linear-gradient(135deg, #8b5cf6, #00f5ff)',
      width: 750, height: 600, content: 'systemmonitor', kind: 'native', status: 'live', category: 'ops',
    },
    taskmanager: {
      id: 'taskmanager', name: 'Task Manager', iconPath: 'task-manager',
      color: 'linear-gradient(135deg, #00ff88, #00f5ff)',
      width: 700, height: 550, content: 'taskmanager', kind: 'native', status: 'live', category: 'ops',
    },
    networktools: {
      id: 'networktools', name: 'Network Tools', iconPath: 'network-tools',
      color: 'linear-gradient(135deg, #ff6b35, #00f5ff)',
      width: 800, height: 600, content: 'networktools', kind: 'native', status: 'live', category: 'ops',
    },
    pods: {
      id: 'pods', name: 'Compute Pods', iconPath: 'compute-pods',
      color: 'linear-gradient(135deg, #00ff88, #3b82f6)',
      width: 900, height: 650, content: 'pods', kind: 'native', status: 'live', category: 'compute',
    },
    snapshots: {
      id: 'snapshots', name: 'Snapshots', iconPath: 'storage',
    ...
    gameeditor: {
      ...
      width: 1100, height: 700, content: 'gameeditor', kind: 'native', status: 'live', category: 'create',
    },
    grudgecloud: {
      id: 'grudgecloud', name: 'GrudgeCloud', iconPath: 'deploy',
      color: 'linear-gradient(135deg, #00f5ff, #3b82f6)',
      width: 700, height: 500, content: 'grudgecloud', kind: 'native', status: 'live', category: 'cloud',
    },
    agentmanager: {
      id: 'agentmanager', name: 'Agent Manager', iconPath: 'agent-manager',
      color: 'linear-gradient(135deg, #00f5ff, #8b5cf6)',
      width: 720, height: 600, content: 'agentmanager', kind: 'native', status: 'live', category: 'ai',
    },
    aisystem: {
      id: 'aisystem', name: 'AI System', iconPath: 'system-overview',
      color: 'linear-gradient(135deg, #00ff88, #00f5ff)',
      width: 550, height: 500, content: 'aisystem', kind: 'native', status: 'live', category: 'ai',
    },
    audiopackages: {
      id: 'audiopackages', name: 'Audio Packages', iconPath: 'audio-packages',
      color: 'linear-gradient(135deg, #ff00aa, #ff6b35)',
      width: 500, height: 450, content: 'audiopackages', kind: 'native', status: 'live', category: 'create',
    },
    fleethub: {
      id: 'fleethub', name: 'Fleet Hub', iconPath: 'cloud',
      color: 'linear-gradient(135deg, #3b82f6, #00f5ff)',
      width: 720, height: 560, content: 'fleethub', kind: 'native', status: 'live', category: 'fleet',
    },
    warlords: {
      id: 'warlords', name: 'Warlords', iconPath: 'games-launcher',
      color: 'linear-gradient(135deg, #b8860b, #ff6b35)',
      width: 400, height: 200, kind: 'external', url: FLEET.warlords, status: 'live', category: 'fleet',
    },
    openlauncher: {
      id: 'openlauncher', name: 'Open', iconPath: 'deploy',
      color: 'linear-gradient(135deg, #00ff88, #3b82f6)',
      width: 400, height: 200, kind: 'external', url: FLEET.open, status: 'live', category: 'fleet',
    },
    forge: {
    ...
    grudgeid: {
      ...
      width: 400, height: 200, kind: 'external', url: FLEET.grudgeId, status: 'live', category: 'fleet',
    },
    aihub: {
      id: 'aihub', name: 'AI Hub', iconPath: 'ai-brain',
      color: 'linear-gradient(135deg, #00f5ff, #8b5cf6)',
      width: 400, height: 200, kind: 'external', url: FLEET.aiHub, status: 'live', category: 'fleet',
    },
    foundry: {
      id: 'foundry', name: 'Foundry', iconPath: 'creating',
      color: 'linear-gradient(135deg, #b8860b, #8b5cf6)',
      width: 400, height: 200, kind: 'external', url: FLEET.character, status: 'live', category: 'fleet',
    },
  };

  const DESKTOP_ICONS = [
    'aivm', 'grudchat', 'agentsquad', 'fleethub', 'pods', 'snapshots',
    'studio3d', 'wasmrunner', 'grudgecloud', 'aistudio', 'observer',
    'gameeditor', 'networktools', 'warlords', 'openlauncher', 'forge', 'foundry',
  ];

  const PURGED = ['debug-static', 'zerotier'];

  function getLiveApps() {
    const out = {};
    for (const [id, app] of Object.entries(APPS)) {
      if (app.status === 'removed' || PURGED.includes(id)) continue;
      out[id] = app;
    }
    return out;
  }
    ...
    return `
      <div style="padding:20px;font-family:system-ui,sans-serif;color:#e8e8ff;height:100%;overflow:auto;
        ...
        <div style="margin-bottom:16px;">
          ...
          <p style="margin:0;opacity:0.7;font-size:13px;">GrudgeOS v${VERSION} · Vercel + Railway + Puter + AI Hub</p>
        </div>
  ...
  function install() {
    global.GrudgeFleetRegistry = {
      VERSION, FLEET, APPS, DESKTOP_ICONS, PURGED,
      getLiveApps, openFleetApp, fleetHubHtml,
    };
    if (global.apps && typeof global.apps === 'object') {
      for (const [id, app] of Object.entries(getLiveApps())) {
        global.apps[id] = { ...global.apps[id], ...app };
      }
      for (const id of PURGED) delete global.apps[id];
    }
    console.info(`[GrudgeFleetRegistry] v${VERSION} · ${Object.keys(getLiveApps()).length} apps`);
  }
